							...
							<form name="search" method="post" action="">
								<div class="search_area">
									...
									<select name="select_key" id="select_key" class="search_sel">
										<option value="con_title">대회명</option>
									</select>
										...
										<c:set var="num" value="${pageMaker.totalCount - ((pageMaker.cri.page -1) *10)}"></c:set>
									        <c:forEach var="item" items="${list}">
												<tr class="cont">
													...
													<td><a href="${pageContext.request.contextPath}/admin/menu02_04update${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.off_date}</a></td>
													<td><a href="${pageContext.request.contextPath}/admin/menu02_04update${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title}</a></td>
												</tr>
