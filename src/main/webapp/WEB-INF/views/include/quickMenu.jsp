...
<div id="quick-menu">
	<ul>
		...
		<li><a href="tel:1800-5475" onclick="ga('send', 'event', '프라이브_2019', '클릭-전화');"><img src="${pageContext.request.contextPath}/resources/img/common/icon_call3.png"></a></li>
		<li><a href="http://pf.kakao.com/_HbkxkT/chat" onclick="ga('send', 'event', '프라이브_2019', '클릭-카톡');"><img src="${pageContext.request.contextPath}/resources/img/common/icon_kakao3.png"></a></li>
		<li><a href="${pageContext.request.contextPath}/menu08_01"><img src="${pageContext.request.contextPath}/resources/img/common/icon_sangdam3.png" style="border-radius:8px;"></a></li>
	</ul>
</div>